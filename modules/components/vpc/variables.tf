...
variable "public_subnets" {
  description = "A list of public subnets inside the VPC arranged { availability_zone : { subnet_name : subnet_cidr}}"
  type        = map(any)
  default     = {}
}

variable "private_subnets" {
  description = "A map of private subnets inside the VPC arranged { availability_zone : { subnet_name : subnet_cidr}}"
  type        = map(any)
  default     = {}
}
